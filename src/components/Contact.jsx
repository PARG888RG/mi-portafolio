...
export default function Contact() {
  ...
  const discordUserId = personalInfo.discordUserId || "123456789012345678"; // Tu ID de usuario de Discord
  ...
  return (
    <section id="contact" className="py-18 px-6 max-w-5xl mx-auto border-t border-[var(--border-color)]">
      ...
      {/* Botón Alargado: Descargar CV (debajo del grid) */}
      <motion.div
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, margin: "-50px" }}
      ...
      >
        <a
          href={cvPath}
          download
          className="glass-card w-full rounded-2xl p-5 flex items-center justify-center gap-3 border border-[var(--border-color)] hover:border-[#D03B13] transition-all duration-300 group shadow-md"
        >
