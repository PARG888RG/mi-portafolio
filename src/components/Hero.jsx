              ...
              <div className="flex items-center gap-3.5">
                {github && (
                  <a
                    ...
                    aria-label="GitHub"
                    className="w-17 h-17 rounded-full border-2 border-[var(--border-color)] bg-[var(--bg-card)] text-[var(--text-main)] flex items-center justify-center hover:border-[#D03B13] hover:text-[#D03B13] hover:scale-110 transition-all duration-300 shadow-md active:scale-95"
                  >
